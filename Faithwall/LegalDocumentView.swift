...
By downloading, installing, or using FaithWall ("the App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.

2. Description of Service

FaithWall is a mobile application that allows users to create personalized lock screen wallpapers with notes. The App integrates with Apple Shortcuts to apply wallpapers to your device.
...
• FaithWall+ Lifetime: One-time payment for permanent access
• FaithWall+ Monthly: Monthly subscription with automatic renewal
...
5.1 App Ownership
• FaithWall and all related intellectual property rights belong to the developer
...
These Terms, together with our Privacy Policy, constitute the entire agreement between you and FaithWall regarding the use of the App.
"""
...
FaithWall is not intended for children under 13. We do not knowingly collect personal information from children under 13.
...
• Contact support@faithwall.app to exercise your rights
...
This agreement is governed by applicable law and constitutes the entire agreement between you and FaithWall Team regarding use of this application.
"""
