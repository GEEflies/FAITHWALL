...
final class FeedbackService {
    ...
    var feedbackEmail: String = "iosfaithwall@gmail.com"
    ...
    func createEmailContent(reason: String, details: String, isPremium: Bool) -> (subject: String, body: String) {
        let subject = "📱 FaithWall Exit Feedback - \(reason)"
        ...
        A FaithWall user submitted exit feedback:
