...
/// Service responsible for verifying that the FaithWall Shortcut has been properly installed and configured.
...
enum ShortcutVerificationService {
    ...
    static let shortcutName = "FaithWall"
    ...
    private static let testFileName = ".faithwall_verification_test.jpg"
    ...
    enum VerificationCheck: String, CaseIterable, Equatable {
        ...
        var userFacingMessage: String {
            switch self {
            case .shortcutFileExists:
                return "The FaithWall Shortcut was not found. Please download and add it from the Shortcuts app."
            case .homeScreenFolderAccess:
    ...
    private enum TestFolder {
        ...
        var url: URL? {
            ...
            guard let baseURL = documentsURL?.appendingPathComponent("FaithWall", isDirectory: true) else {
                return nil
            }
