...
struct SettingsView: View {
    ...
    private let supportEmail = "iosfaithwall@gmail.com"
            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: 14) {
                        ...
                        Button(action: {
                            ...
                            if let url = URL(string: "mailto:iosfaithwall@gmail.com") {
...
private extension SettingsView {
    ...
    private func shareApp() {
        let shareText = """
        Just discovered FaithWall - it turns your lock screen into a productivity powerhouse! 🚀
        
        See your goals every time you unlock your phone. Game changer! 
        
        #ProductivityHack #FaithWall #LockScreen
        """
    ...
    private func getLegalDocumentContent() -> String {
        ...
        case .termsOfService:
            ...
            FaithWall is a productivity application that allows users to create custom wallpapers with personal notes and reminders for their iOS devices.
            ...
            For questions or support, contact us at: iosfaithwall@gmail.com
