...
extension ShortcutSetupViewModel {
    ...
    struct SetupStep: Identifiable {
        ...
        static let allSteps: [SetupStep] = [
            SetupStep(id: 1, description: "Download the FaithWall Shortcut"),
            SetupStep(id: 2, description: "Shortcuts will open automatically"),
            SetupStep(id: 3, description: "When prompted, select the folders: Navigate to Files → On My iPhone → FaithWall → HomeScreen (and LockScreen)"),
